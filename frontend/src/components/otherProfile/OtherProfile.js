...
const OtherProfile = () => {
    ...
    const {otherName, isProfileOpen, setisProfileOpen} = useContext(userContext);
    ...
    return (
            ...
            <div className='prof-pic'>
                <img src={otherUserData.profilePicture} 
                    alt='img'
                    className='profImg'
                 />
            </div>
            ...
            {otherUserData.about ? (
                ...
                <p className="aboutPara" style={{color:"gray"}}>They haven't wrote anything</p>
            )}
            </p>
        </div>
    </div>
